...
public class WaveformViewNew extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public WaveformViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveformViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
