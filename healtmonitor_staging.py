...
def allDoctor():
    try:
        ...
        query= "select us.ID,us.name as DoctorName,us.Email as Email,us.mobile,us.Gender,,HM.hospital_name,(HM.Address)hospital_address,HM.ID as Hospital_Id,HBS.ID as HubId"
