...
def allDoctor():
    try:
        ...
        query= " select um.ID,um.name as DoctorName,um.Email,um.Gender,hsm.ID as Hospital_Id,hsm.hospital_name,hm.ID as HubId,hsm.hospital_address,hm.HubName from userMaster um,HubMaster hm,Hospital_master hsm,"
