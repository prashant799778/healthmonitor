...
class Login extends React.Component {
  ...
  loginHandler = e => {
    ...
    let api = `https://smarticuapi.fourbrick.in/login1?name=${this.state.name}&password=${this.state.pass}&browserId=${unique_id}`;
    axios
      .get(api)
      .then(response => {
  ...
  // ''' https://smarticuapi.fourbrick.in/Login?name=Prashant&password=11233''
  // https://smarticuapi.fourbrick.in/Login?name=Prashant&password=11233
  callapi = () => {
    //  let api=" https://smarticuapi.fourbrick.in/Login?name="+this.state.name+"&password="+this.state.pass
    // let api = `https://smarticuapi.fourbrick.in/Login?name=${this.state.name}&password=${this.state.pass}`;
    // axios
    //   .get(api)
    //   .then(response => {
