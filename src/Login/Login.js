...
class Login extends React.Component {
  ...
  loginHandler = e => {
    ...
    let api = `https://digitologyhealthcare.com:5053/login1?name=${this.state.name}&password=${this.state.pass}&browserId=${unique_id}`;
    axios
      .get(api)
      .then(response => {
  ...
  // ''' https://digitologyhealthcare.com:5053/Login?name=Prashant&password=11233''
  // https://digitologyhealthcare.com:5053/Login?name=Prashant&password=11233
  callapi = () => {
    //  let api=" https://digitologyhealthcare.com:5053/Login?name="+this.state.name+"&password="+this.state.pass
    // let api = `https://digitologyhealthcare.com:5053/Login?name=${this.state.name}&password=${this.state.pass}`;
    // axios
    //   .get(api)
    //   .then(response => {
