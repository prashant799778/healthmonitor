                      ...
                      <div className="col-sm-12 col-md-12">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <h6 className="m-0 text-black">
                                <font color="white">Paitent Information</font>
                              </h6>
                              <span className="line" />
                            </div>
                            <div className="col-sm-12 col-md-12  ">
                                ...
                                <div className="row">
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    <label className="title-fom">
                                      <font color="white">Paitent name</font>
                                    </label>
                                    <input
                                      required
                                      onChange={e => {
                                  ...
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    ...
                                    <select
                                      ...
                                      className="form-control fom-hit"
                                      id="gender-info"
                                    >
                                  ...
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    ...
                                    <select
                                      value={this.state.device_allocate}
                                      onChange={e => {
                                        this.setState({
                                          device_allocate: e.target.value
                                        });
                                      }}
                                      className="form-control fom-hit"
                                      id="gender-info"
                                  ...
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    <label
                                      ...
                                      htmlFor="gender-info"
                                    >
                                      <font color="white">Hospital Name</font>
                                    </label>
                                    <select
                                  ...
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    <label
                                      ...
                                      htmlFor="gender-info"
                                    >
                                      <font color="white"> Blood Group</font>
                                    </label>
                                    <select
                                    ...
                                    <div className="btn-bx">
                                      {
                                        <button
                                          type="submit"
                                          className="form-btn sbmtbtn btn-success"
                                          style={{
                                            background: "#4FA746",
                                            borderColor: "#4e72df"
                                          }}
