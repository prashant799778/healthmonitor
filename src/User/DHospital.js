...
class User extends React.Component {
  ...
  callapi = () => {
    ...
    let api = "http://smarticuapi.fourbrick.in:5053/doctorLoginHospital";
    axios
      .post(api, jsons)
      .then(response => {
        // handle success
  ...
  // }
  submitapi = () => {
    let api = "http://smarticuapi.fourbrick.in:5053/insertHubMaster";
    let json = {
  ...
  updatetapi = () => {
    let api = "http://smarticuapi.fourbrick.in:5053/allPatient";
    let json = {
  ...
  patientListApi = hospitalID => {
    let api = "http://smarticuapi.fourbrick.in:5053/HospitalPatientDetails";
    let json = {
