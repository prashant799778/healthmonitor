...
class User extends React.Component {
  ...
  delete = () => {
    let api =
      "http://134.209.153.34:5004/deleteUser?userid=" + this.state.deleteid;
    axios
      .get(api)
      .then(response => {
        // handle success
  ...
  callapi = () => {
    ...
    let api = "https://smarticuapi.fourbrick.in:5053/doctorLoginHospital";
    axios
      .post(api, jsons)
      .then(response => {
        // handle success
  ...
  // }
  submitapi = () => {
    let api = "https://smarticuapi.fourbrick.in:5053/insertHubMaster";
    let json = {
  ...
  updatetapi = () => {
    let api = "https://smarticuapi.fourbrick.in:5053/allPatient";
    let json = {
  ...
  //! -------------------------------- anil-work ------------------------------- */
  handleEyeClick = hospitalID => {
    this.setState({
      isEyeClicked: !this.state.isEyeClicked
      // myHospitalId: hospitalID
    });

    console.log(this.state.isEyeClicked);
    console.log("ye hospital id he", hospitalID);

    // if(this.state.isEyeClicked){
    this.patientListApi(hospitalID);
    // }
  };

  patientListApi = hospitalID => {
    let api = "https://smarticuapi.fourbrick.in:5053/HospitalPatientDetails";
    let json = {
    ...
    axios
      ...
      .then(response => {
        // handle success
        console.log("patient list api", response);
        if (response) {
          if (response && response.data && response.data.status === "true") {
            // alert("Data Updated Successfully");
            // this.setState({ err: "" });
            // this.callapi();
            this.setState({ patientListData: response.data.result });
  ...
  { history.push('/')
   window.location.reload();}
    ...
    // }
    console.log("ye patient list state he", this.state.patientListData);
          ...
          <div id="wrapper">
            ...
            {!this.state.isList &&  <span style={{color:'#ffffff'}} className="adu">Cancel</span>}
                    ...
                    <div className="row" style={{ background: "#1E1E2F" }}>
                      <div className="col-sm-12 col-md-12">
                        ...
                        >
                          {" "}
                          <div
                            className="adduser fadeInLeft animated"
                            style={{ background: "#26293B" }}
                          >
                            {" "}
                            {/* Card user */}
                            ...
                            <div
                              style={{ background: "#26293B" }}
                              className="info-headding"
                            >
                              <h6 className="m-0 text-black">
                                <font color="white">Hospital Information</font>
                              </h6>
                              <span className="line" />
                            </div>
                            <div className="col-sm-12 col-md-12  ">
                              ...
                              >
                                <div className="row">
                                  <div className="col-sm-12 col-md-3 innr-bx">
                                    <label className="title-fom">
                                      <font color="white">Hub name</font>
                                    </label>
                                    <input
                                      required
                                      onChange={e => {
                ...
                <div class="container-box">
                  {!this.state.isEyeClicked && (
                    <div class="container">
                      <div class="row">
                        {Array.isArray(this.state.hubs) &&
                          this.state.hubs.map((item, i) => {
                            return (
                              <div
                                ...
                                key={item.HospitalId}
                                onClick={() =>
                                  this.handleEyeClick(item.HospitalId)
                                }
                              >
                  ...
                  {this.state.isEyeClicked && (
                    ...
                    <div className="container-fluid tbl-b animated--grow-in adduserr">
                        ...
                        <div className="col-sm-12 col-md-12">
                          ...
                          >
                            <div
                              ...
                              style={{ background: "#26293B" }}
                            >
                              <h6 className="m-0 text-white">Patient List</h6> <h6 style={{color:"green",cursor:"pointer"}} onClick={()=>this.setState({isEyeClicked:!this.state.isEyeClicked})}>Go Back</h6>
                            ...
                            <div className="card-body">
                              <div className="table-responsive srt">
                                <table
                                  ...
                                  className="table table-striped table-bordered innr-table"
                                  id="dataTable"
                                  width="100%"
                                  cellSpacing={0}
                                >
                             ...
                             <tr>
                               ...
                               <th>Action</th>
                                  ...
                                  <tbody>
                                    <tr></tr>
                                    {Array.isArray(
                                      this.state.patientListData
                                    ) ? (
                                      this.state.patientListData.map(
                                        (item, i) => {
                                          return (
                                            <tr id={i}>
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  Select "Delete" below if you are ready to delete BD.
                </div>
