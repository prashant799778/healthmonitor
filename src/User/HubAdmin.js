...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://smarticuapi.fourbrick.in:5053/deleteHubadminhub"
    let jsn={
...
statusapi=()=>{
  ...
  callapi=()=>{
    ...
    this.setState({isList:true,isEdit:false})
     ...
     let api="https://smarticuapi.fourbrick.in:5053/allHubadmin"
      axios.post(api)
    .then((response)=> {
      // handle success
         
      
      console.log("allHubAdmin",response)
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="https://smarticuapi.fourbrick.in:5053/addHubadmin"
      let json={
        "HubId":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://smarticuapi.fourbrick.in:5053/updateHubadmin"
      ...
      return (
        ...
        <div >
          ...
          <div id="wrapper">
            ...
            {this.state.isList && <span style={{color:'#ffffff'}} className="adu"><i className="fas fa-plus" />Add HubAdmin</span>}
                    ...
                    <div className="col-sm-12 col-md-12">
                     <form onSubmit={this.uploadHandler} style={{background:'#26293B'}}  > <div className="adduser fadeInLeft animated" style={{background:'#26293B'}}  > {/* Card user */}              
                        <div className="icon-bx pd">
                          ...
                          <font color="white">Add HubAdmin</font>
                        ...
                        <div style={{background:'#26293B'}}   className="info-headding">
                          <h6 className="m-0 text-black"><font color="white">HubAdmin Information</font></h6>
                          <span className="line" />
                        </div>
                        ...
                        <div className="col-sm-12 col-md-12  ">
                          <div style={{background:'#26293B'}}  className="container form-box">
                            ...
                            <div className="col-sm-12 col-md-3 innr-bx">
                              ...
                              <div className="col-sm-12 col-md-3 innr-bx">
                                <label className="title-fom"><font color="white">HubAdmin Name</font></label>
                    ...
                    <div className="col-sm-12 col-md-12">
                      <div   style={{background:'#26293B'}} className="card mb-4">
                        <div className="card-header py-3 d-flex justify-content-between"  style={{background:'#26293B'}}>
                          <h6  className="m-0 text-white">HubAdmin List</h6>
