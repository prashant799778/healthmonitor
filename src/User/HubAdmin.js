...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://smarticuapi.fourbrick.in/deleteHubadminhub"
    let jsn={
...
statusapi=()=>{
  ...
  callapi=()=>{
    ...
    this.setState({isList:true,isEdit:false})
     ...
     let api="https://smarticuapi.fourbrick.in/allHubadmin"
      axios.post(api)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="https://smarticuapi.fourbrick.in/addHubadmin"
      let json={
        "HubId":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://smarticuapi.fourbrick.in/updateHubadmin"
