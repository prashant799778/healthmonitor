...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="http://159.65.146.25:5053/deleteHubadminhub"
    let jsn={
 ...
 statusapi=()=>{
  ...
  callapi=()=>{
    ...
    this.setState({isList:true,isEdit:false})
     ...
     let api="http://159.65.146.25:5053/allHubadmin"
      axios.post(api)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="http://159.65.146.25:5053/addHubadmin"
      let json={
        "HubId":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="http://159.65.146.25:5053/updateHubadmin"
