...
class SideBar extends React.Component{
  ...
  //  }
  //  else if(window.location.pathname == "/drf"){
  ...
  //   element.classList.add("active");
  // }
  // else if(window.location.pathname == "/add_new_fields"){
  //   let element = document.getElementById('side66');
  //   element.classList.add("active");
  // }
  // else if(window.location.pathname == "/smart"){
  //   let element = document.getElementById('side55');
  //   element.classList.add("active");
  // }
  // else if(window.location.pathname == "/add2"){
  //   let element = document.getElementById('side77');
  //   element.classList.add("active");
  // }
