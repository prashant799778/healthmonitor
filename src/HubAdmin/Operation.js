...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://digitologyhealthcare.com:5053/deleteoperationHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="https://digitologyhealthcare.com:5053/hubadminOperations"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="https://digitologyhealthcare.com:5053/addOperator"
      let json={
        "Hospital_Id":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://digitologyhealthcare.com:5053/updateOperator"
