...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://api.digitologyhealthcare.com:5053/deleteoperationHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="https://api.digitologyhealthcare.com:5053/hubadminOperations"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
         
      
      console.log("allOperation",response)
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="https://api.digitologyhealthcare.com:5053/addOperator"
      let json={
        "Hospital_Id":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://api.digitologyhealthcare.com:5053/updateOperator"
      ...
      return (
        ...
        <div >
          ...
          <div id="wrapper">
            ...
            {this.state.isList && <span style={{color:'#ffffff'}} className="adu"><i className="fas fa-plus" />Add Operation</span>}
                    ...
                    <div className="col-sm-12 col-md-12">
                     <form onSubmit={this.uploadHandler} style={{background:'#26293B'}}  > <div className="adduser fadeInLeft animated" style={{background:'#26293B'}}  > {/* Card user */}              
                        <div className="icon-bx pd">
                          ...
                          <font color="white">Add Operation</font>
                        ...
                        <div style={{background:'#26293B'}}   className="info-headding">
                          <h6 className="m-0 text-black"><font color="white">Operation Information</font></h6>
                          <span className="line" />
                        </div>
                        ...
                        <div className="col-sm-12 col-md-12  ">
                          <div style={{background:'#26293B'}}  className="container form-box">
                            ...
                            <div className="col-sm-12 col-md-3 innr-bx">
                              ...
                              <div className="col-sm-12 col-md-3 innr-bx">
                                <label className="title-fom"><font color="white">Operation Name</font></label>
                    ...
                    <div className="col-sm-12 col-md-12">
                      <div   style={{background:'#26293B'}} className="card mb-4">
                        <div className="card-header py-3 d-flex justify-content-between"  style={{background:'#26293B'}}>
                          <h6  className="m-0 text-white">Operation List</h6>
                            ...
                            <table style={{color:'aliceblue'}} className="table table-striped table-bordered innr-table" id="dataTable" width="100%" cellSpacing={0}>
                              <thead  style={{background:'#26293B'}}>
                                <tr  style={{background:'#1E1E2F',color:'#FFFFFF'}}>
                                  <th style={{textAlign:"center",color:'aliceblue'}}>Operation ID</th>
                                  <th style={{textAlign:"center",color:'aliceblue'}}>Operation Name</th>
