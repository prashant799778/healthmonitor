...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="http://3.0.218.219:5053/deleteoperationHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  getHospitals=(id)=>{
    ...
    if(id!=undefined){
     ...
     let api="http://3.0.218.219:5053/hospitalMaster"
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="http://3.0.218.219:5053/hubadminOperations"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="http://3.0.218.219:5053/addOperator"
      let json={
        "Hospital_Id":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="http://3.0.218.219:5053/updateOperator"
