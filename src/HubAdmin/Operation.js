...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="http://159.65.146.25:5053/deleteoperationHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="http://159.65.146.25:5053/hubadminOperations"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="http://159.65.146.25:5053/addOperator"
      let json={
        "Hospital_Id":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="http://159.65.146.25:5053/updateOperator"
                            ...
                            <table style={{color:'aliceblue'}} className="table table-striped table-bordered innr-table" id="dataTable" width="100%" cellSpacing={0}>
                              <thead  style={{background:'#26293B'}}>
                                <tr  style={{background:'#1E1E2F',color:'#FFFFFF'}}>
                                  ...
                                  <th style={{textAlign:"center",color:'aliceblue'}}>No. ofPatient</th>
