...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://api.digitologyhealthcare.com:5053/deleteNurseHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="https://api.digitologyhealthcare.com:5053/hubadminNurse"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
     ...
     if(gens==3){
      ...
      let api="https://api.digitologyhealthcare.com:5053/addUser"
      let json={
        "Hospital_Id":hls,
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://api.digitologyhealthcare.com:5053/updateNurseMaster"
