...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="https://smarticuapi.fourbrick.in:5053/deleteNurseHospital"
    let jsn={
 ...
 .catch( (error)=> {
  ...
  callapi=()=>{
    ...
    let jsn={
     ...
     let api="https://smarticuapi.fourbrick.in:5053/hubadminNurse"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="https://smarticuapi.fourbrick.in:5053/updateNurseMaster"
