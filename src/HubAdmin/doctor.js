...
isValid:true,emailError:false,
  ...
  delete=()=>{
    ...
    let api="https://api.digitologyhealthcare.com:5053/deleteDoctorHospital"
    let jsn={
  ...
  callapi=()=>{
   ...
   let jsn={
    "HubId":localStorage.getItem("hub_id","")
     ...
     let api="https://api.digitologyhealthcare.com:5053/hubadminDoctor"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
...
hids.push(this.state. HListId[item])
      ...
      let api="https://api.digitologyhealthcare.com:5053/addDoctor"
      let json=
...
hids.push(this.state. HListId[item])
     ...
     let api="https://api.digitologyhealthcare.com:5053/updateDoctorMaster"
