...
isValid:true,emailError:false,
  ...
  delete=()=>{
    ...
    let api="http://3.0.218.219:5053/deleteDoctorHospital"
    let jsn={
  ...
  callapi=()=>{
   ...
   let jsn={
    "HubId":localStorage.getItem("hub_id","")
     ...
     let api="http://3.0.218.219:5053/hubadminDoctor"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
...
hids.push(this.state. HListId[item])
      ...
      let api="http://3.0.218.219:5053/addDoctor"
      let json=
...
hids.push(this.state. HListId[item])
     ...
     let api="http://3.0.218.219:5053/updateDoctorMaster"
