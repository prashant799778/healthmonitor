...
isValid:true,emailError:false,
  ...
  delete=()=>{
    let api="http://smarticuapi.fourbrick.in:5053/deleteHospital"
    let jsn={
 ...
 let jsn={
  "HubId":localStorage.getItem("hub_id","")
     ...
     let api="http://smarticuapi.fourbrick.in:5053/hubadminHospital"
      axios.post(api,jsn)
    .then((response)=> {
      // handle success
  ...
  .catch( (error)=> {
    ...
    submitapi=()=>{
      ...
      let api="http://smarticuapi.fourbrick.in:5053/insertHospitalMaster"
      let json={
 ...
 alert("User Created Successfully")
    ...
    updatetapi=()=>{
     ...
     let api="http://smarticuapi.fourbrick.in:5053/updateHospitalmaster"
     let json={
