...
return <li>{message}</li> })}
 ...
 subscribe({
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `https://api.digitologyhealthcare.com:5053/doctorLoginDashboard`, jsons
      )
      .then(res => {
...
console.log(deviceId)
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.digitologyhealthcare.com:5053/Device_master_select?hospital_Name=${hospitals}`
      )
      .then(res => {
        if (res.data) {
...
console.log(deviceId)
  ...
  //   axios
  //     .get(
  //       `https://api.digitologyhealthcare.com:5053/Device_master_select?hospital_Name=${e.target.value}`
  //     )
  //     .then(res => {
  //       if (res.data) {
  ...
  // const patientApi = () => {
  //   axios
  //     .get("https://api.digitologyhealthcare.com:5053/Patient_master_select")
  //     .then(res => {
  ...
  useEffect(() => {
    axios
      .get("https://api.digitologyhealthcare.com:5053/hospital_master_list1")
      .then(res => {
        console.log(res.data.result);
