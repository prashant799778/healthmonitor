...
var client2  = mqtt2.connect('mqtts://mqtt.digitologyhealthcare.com:8083')
 ...
 this.setState({client2: client2 },()=>{
  client2.on('connect', (
    ...
    client2.subscribe(this.props.topic+"/spo2",  (err)=> {
      console.log("messageOneSpo",this.props.topic+"/spo2  on subscribe")
      if (!err) {
    ...
    client2.on('message', (topic, message) =>{
        ...
        console.log("messageOneSpo", (topic)+","+ this.props.topic+"/spo2  on message")
        if((this.props.topic+"/spo2")=== topic){
        ...
        console.log("messageOneSpo","spo on con client");  
  })
 })
