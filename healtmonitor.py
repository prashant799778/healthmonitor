...
def getPatientDetail():
    try:
        ...
        cursor.close()
        for i in data1:
            query2="select pdm.doctorId,pm.PatientId,pm.PatientName,pm.Gender,pm.roomNumber,pm.Bed_Number as Bed No,pm.Address,pm.BloodGroup,pm.Email from Patient_master pm,userHospitalMapping uhm,patientDoctorMapping pdm where pdm.Patient_Id=pm.PatientId and pm.hospitalId=uhm.hospitalId " 
