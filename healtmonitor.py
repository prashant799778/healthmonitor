...
def downloadPatientDetails():
    try:
        ...
        # json1=request.get_data() 
        # data=json.loads(json1.decode("utf-8")) 
        query1= " select pm.PatientName,p.Patient_Id,p.temperature,p.lowPressure,p.highPressure,p.heartRate,p.pulseRate,p.spo2 from Patient_Vital_master p,Patient_master pm where pm.PatientId=p.Patient_Id limit 10;"
