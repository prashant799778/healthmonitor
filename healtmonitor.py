...
def hubadminPannel():
    try:
        ...
        for i in data99:
            query1="select  count(*) as  count from userMaster  as um   where um.Usertype_Id='2'    and um.ID IN (select uhm.userId  from  userHospitalMapping  where uhm.Usertype_Id= '2'  AND hospitalId='"+str(i["HospitalId"])+"' );" 
