...
def getPatientDetail():
    try:
        ...
        cursor.close()
        for i in data1:
            query2="select pm.PatientId,pm.PatientName as Patient Name,pm.Gender,pm.roomNumber as Room No.,pm.Bed_Number as Bed No.,pm.Address,pm.BloodGroup,pm.Email from Patient_master pm,userHospitalMapping uhm where pm.hospitalId=uhm.hospitalId " 
