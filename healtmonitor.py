...
def hubadminPannel():
    try:
        ...
        for i in data99:
            query1="select um.ID from userMaster as um,userHospitalMapping as uhm  where um.Usertype_Id=uhm.Usertype_Id and  uhm.Usertype_Id= '2'  aND uhm.hospitalId='"+str(i["ID"])+"' ;" 
