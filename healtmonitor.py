    ...
    try:
        ...
        if data:
            for i in data:
                ...
                query4 = "select pdm.doctorId as DoctorId from patientDoctorMapping as pdm,patientmaster as pm where pdm.Patient_Id=pm.PatientId,pdm.Patient_Id='"+str(patientId)+"'"
                conn=Connection()
                cursor = conn.cursor()
