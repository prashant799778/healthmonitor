...
def getPatientList():
    ...
    try:
        ...
        query1 = 'select pm.hospitalId,pdm.Patient_Id,pdm.doctorId,pm.PatientName,pm.PhoneNo,pm.Address from patientDoctorMapping as pdm,Patient_master as pm where pdm.Patient_Id=pm.PatientId and pdm.doctorId="'+str(data['doctorId'])+'"'
        conn = Connection()
        cursor = conn.cursor()
        cursor.execute(query1)
        data2 = cursor.fetchall()
