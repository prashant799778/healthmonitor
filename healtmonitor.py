...
def getPatientDetail():
    try:
        ...
        cursor.close()
        for i in data1:
            query2="select pm.PatientId,pm.PatientName,pm.Gender,pm.roomNumber,pm.Bed_Number,pm.Address,pm.BloodGroup,pm.Email from Patient_master pm,userHospitalMapping uhm where pm.hospitalId=uhm.hospitalId " 
