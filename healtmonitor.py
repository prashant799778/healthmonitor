...
def doctorLoginDashboard():
    try:
        ...
        for i in data1:
            ...
            query2="select PatientId,hospitalId,PatientName,json_extract(heartRate) as heartRate ,spo2,highPressure,lowPressure,pulseRate,temperature,BloodGroup,DeviceMac,Bed_Number,roomNumber,Gender,age from Patient_master pm,patientDoctorMapping pdm where pm.Status<>'2' and pdm.Patient_Id=pm.PatientId " 
